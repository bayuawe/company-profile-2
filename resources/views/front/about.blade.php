        ...
        <div class="container py-16">
            ...
            <div class="group relative flex gap-x-5">
                ...
                <div
                    ...
                    <div class="relative z-10 size-6 flex justify-center items-center">
                        <svg class="shrink-0 size-6 text-gray-600" width="32" height="32" viewBox="0 0 32 32"
            ...
            <div class="group relative flex gap-x-5">
                ...
                <div
                    class="relative group-last:after:hidden after:absolute after:top-8 after:bottom-2 after:start-3 after:w-px after:-translate-x-[0.5px] after:bg-gray-200">
                    <div class="relative z-10 size-6 flex justify-center items-center">
                        <svg class="shrink-0 size-6 text-gray-800" xmlns="http://www.w3.org/2000/svg" width="24"
        ...
        <div class="grid gap-12 py-12">
            <div>
                <div class="aspect-w-16 aspect-h-7">
                    <img class="w-full max-h-96 object-cover rounded-xl"
